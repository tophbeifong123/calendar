...
function ListPost({ fetchPost, subjectData, fetchTrigger }: any) {
    ...
    return (
        <>
            <button
                className="btn btn-circle bg-[#ebebeb]  rounded-full p-2 shadow-sm w-[45px] h-[45px] "
            ...
            <label className=" rounded-full  text-left relative top-3 right-10 text-gray-400">
                ประกาศ
            </label>
            <Toaster position="bottom-right" />
            {modalOpen && (
                <div className="modal-overlay fixed flex justify-center items-center top-0 left-0 z-10 bg-black bg-opacity-50 w-full h-full text-black">
