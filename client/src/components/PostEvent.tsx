...
function PostEvent({ fetchTrigger }: any) {
    ...
    function toLocalISOString(date: any, timeZone: any) {
        ...
        return (
            format(zonedDate, "yyyy-MM-dd'T'HH:mm:ss.SSS", { timeZone }) + "Z"
        );
    }
        ...
        <MuiPickersUtilsProvider utils={DateFnsUtils}>
            <>
                <div className="grid grid-cols-2 gap-4 text-black">
                    <button
                        className="btn btn-circle bg-[#ebebeb]  rounded-full p-2 shadow-sm w-[45px] h-[45px] mt-3"
                    ...
                    <label className="rounded-full relative top-7 right-10 text-gray-400">
                        แจ้งประกาศ
                    </label>
                    <ListPost
                        fetchPost={reloadPosts}
