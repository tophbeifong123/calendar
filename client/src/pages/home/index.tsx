...
function Home() {
    ...
    useEffect(() => {
        if (
            ...
            const newEventsFromClass = classDate.map((item: any) => ({
                ...
                description: ` ${
                    item.roomId || item.roomName || "ไม่ระบุห้องเรียน"
                }`,
                ...
                endTime: `${item.stopTime.substring(
                    0,
                    2
                )}:${item.stopTime.substring(2, 4)}`,
            ...
            const newEventsFromExam = examDate.map((item: any) => ({
                ...
                start: `${item.examDate.substring(
                    ...
                    0,
                    2
                )}:${item.examStartTime.substring(2, 4)}`,
    ...
    return (
        <div className="bg-[#2D3F50] h-screen">
            <CustomNavbar />
            {loading ? (
                <>
                    <div className="flex justify-center items-center h-screen  from-orange-100 to-blue-100">
